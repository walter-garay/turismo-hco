                    ...
                    <form action="{{ route('admin.actividades.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="number" step="0.01" name="precio" id="precio" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('precio') }}" required>
                                @error('precio')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="categoria" id="categoria" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('categoria') }}">
                                @error('categoria')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="fecha_evento" id="fecha_evento" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('fecha_evento') }}">
                                @error('fecha_evento')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="time" name="hora_inicio" id="hora_inicio" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('hora_inicio') }}">
                                @error('hora_inicio')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="time" name="hora_fin" id="hora_fin" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('hora_fin') }}">
                                @error('hora_fin')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
