            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 flex items-center space-x-4 w-full">
                        <!-- Buscador -->
                        <form action="{{ route('destinos.index') }}" method="GET" class="flex items-center space-x-4 w-full">
                        ...
                        <div class="relative w-44">
                            <x-dropdown>
                                <x-slot name="trigger">
                                    <button class="bg-gray-200 text-gray-600 font-bold py-2 px-4 rounded hover:bg-gray-300">
                                        Tipo de destino
                                    </button>
                                </x-slot>
                                ...
                                <x-slot name="content">
                                    ...
                                    @foreach ($categorias as $categoria)
                                        <x-dropdown-link :href="route('destinos.index', ['categoria' => $categoria->categoria])">
                                            {{ $categoria->categoria }}
                                        </x-dropdown-link>
                                    @endforeach
                                </x-slot>
